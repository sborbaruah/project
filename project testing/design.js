...
function(){
	...
	quickforms.form.domParsers.push(function(formObj){
		...
		{
			formObj.dom.find('.buttons').append('<a href="#" rel="external" onClick="quickforms.design(\''+formObj.id+'\')" data-role="button" data-inline="true" data-icon="gear">Design</a>'); 
			formObj.dom.find('.buttons').trigger('create');
		}
	});
